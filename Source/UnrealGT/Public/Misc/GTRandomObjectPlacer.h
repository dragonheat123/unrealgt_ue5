...
public:
  ...
  UPROPERTY(EditAnywhere, Category = bShouldAlignToGround)
  bool bShouldAlignToGround;

  UPROPERTY(EditAnywhere, Category = bRandomYaw)
  bool bRandomYaw;

  UPROPERTY(EditAnywhere, Category = RandomMaterials)
  TArray<UMaterialInterface *> RandomMaterials;

  UPROPERTY(EditAnywhere, Category = RandomMaterialSlotID)
